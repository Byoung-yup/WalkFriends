...
//
    ...
    func makeHomeViewModel(actions: HomeViewModelActions) -> HomeViewModel {
        return HomeViewModel(dataUseCase: makeDataUsecase(), actions: actions)
    }
    ...
    func makeSetupProfileViewModel(actions: SetupViewModelActions) -> SetupProfileViewModel {
        return SetupProfileViewModel(dataUseCase: makeDataUsecase(), actions: actions)
    }
...
//    }
    ...
    func makeHomeCoordinator(navigationController: UINavigationController, dependencies: HomeCoordinatorDependencies) -> HomeCoordinator {
        return HomeCoordinator(navigationController: navigationController, dependencies: dependencies)
    }
